...
const BlogPage = () => {
  ...
  const allBlogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      content: `
        ...
        <p>Investing in a robust digital backbone today ensures that organizations will be prepared for the technological advances and market changes of tomorrow.</p>
      `,
    },
  ]
  ...
  const filteredPosts = allBlogPosts.filter((post) => {
    ...
    switch (searchBy) {
      ...
      case 'Time':
        // If you add times later, this will still work; for now it falls back to date text
        return post.date.toLowerCase().includes(q)
      case 'Name':
...
.sheen-text {
  ...
  color: transparent;
  animation: shimmer 6s linear infinite; /* slower */
}
