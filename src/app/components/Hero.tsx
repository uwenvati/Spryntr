...
export default function Hero() {
  ...
  return (
    <section id="top" className="mt-24 md:mt-0 flex flex-col-reverse md:flex-row items-center justify-between w-full bg-[#FCFCFD] pb-16 overflow-hidden relative z-10 animate-fade-in">
      {/* Left side */}
      <div className="w-full md:w-[60%] px-6 md:px-16 space-y-6 relative">
        ...
        <h1 className="mt-0 font-semibold leading-[1.1] text-black text-5xl md:text-6xl lg:text-7xl">
